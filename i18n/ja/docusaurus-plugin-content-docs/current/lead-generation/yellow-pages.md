...
### ステップ 1: Directory Assistant に移動

1. 左側のナビゲーションメニューで **Insights** をクリック
2. **Directory Assistant** カードを選択
3. イエローページタスクリストが表示されます
...
1. 左側のナビゲーションメニューで **Insights** を開き、**Directory Assistant** を選択
...
左側のナビゲーションメニューで **Insights** を開き、**Directory Assistant** を選択してすべてのタスクを表示します。
...
2. 左側のナビゲーションメニューで **Insights** を開き、**Outreach Campaign** を選択
3. **Outreach Tasks** を選択
4. 抽出されたメールで **CSV をインポート**
5. アウトリーチ用の **テンプレートを作成**
6. **キャンペーンを開始**
