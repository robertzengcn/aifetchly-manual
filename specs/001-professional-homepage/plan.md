...
│   └── component-interfaces.md # React component contracts
└── checklists/
...
See [contracts/component-interfaces.md](./contracts/component-interfaces.md) for complete details.
...
- ✅ `contracts/component-interfaces.md` - All component interfaces
