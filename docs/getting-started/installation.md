...
1. [Configure proxy settings](../lead-generation/proxy-setup) (recommended for information organization)
2. [Set up contact profile insights](../lead-generation/contact-extraction)
